<?php
  //Initilizing empty string
  $username=$password=$confirm_password=$address=$city="";
  $username_err=$password_err=$confirm_password_err=$address_err=$city_err="";
  ...
  //Stripping space, backslashes, and specialhtmlchars
  ...
  if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    if(empty($_POST["username"])){
      ...
      $username = test_input($_POST["username"]);
      //The username should only consists of characters and no special characters
    ...
    if(empty($_POST["confirm_password"])){
      $confirm_password_err = "Confirm password field is required.";
    }else{
      $confirm_password = test_input($_POST["confirm_password"]);
      if($password==$confirm_password){
        $confirm_password_err = "Password Matched";
      }else{
